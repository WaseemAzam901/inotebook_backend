    ...
    <div className="container my-3">
        ...
        <form className="my-3">
          <div className="form-group">
            ...
            <input type="text" className="form-control" id="title" name='title' placeholder="Enter Title" value={note.title} onChange={onChange} minLength={5} required/>
          </div>
          ...
          {/* kyu k yeh button form ka hissa nahi hai toh is liye ap is  per minlength etc nahi laga saktay  */}
